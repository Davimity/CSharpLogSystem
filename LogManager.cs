...
public class LogManager{
    ...
    #region constructors
        ...
        public LogManager(bool writeInitialData = false)
        {
            logPath = InitPath();
            writeTime = true;
            writeType = true;
        ...
        public LogManager(string logPath, bool writeTime = true, bool writeType = true, bool writeInitialData = true, string timeFormat = "HH:mm:ss:ff"){
    ...
    #region methods
        ...
        private string InitPath(){
            logPath = Path.Combine(Directory.GetCurrentDirectory(), "Logs", startMoment + ".log");
            return logPath;
        }
